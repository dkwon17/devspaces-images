...
FROM ubi8/nodejs-20:1-69.1732637112 as checode-linux-libc-ubi8-builder
...
FROM ubi9/nodejs-20:9.5-1733148170 as checode-linux-libc-ubi9-builder
# hadolint ignore=DL3002
USER root
...
FROM rhel8/go-toolset:1.22.7-5 as machineexec-builder
ENV GOPATH=/go/
# hadolint ignore=DL3002
USER root
...
FROM ubi8:8.10-1132 as ubi-builder
